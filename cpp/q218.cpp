...
public:
    vector<vector<int>> getSkyline(vector<vector<int>>& buildings) {
        // Iterate through each building, add left edge and the index of the building
        ...
        // Sort edges by non-decreasing order. (For Sweep line algorithm)
        ...
        while (idx < edges.size()){
            ...
            // If the current edge is the left edge of a building (idx ->)
